...
<header data-am-widget="header" class="am-header am-header-default">
    <div class="am-header-left am-header-nav">
        <a href="${ctx}/index"> <i class="am-header-icon am-icon-home"></i></a>
    </div>
    <h1 class="am-header-title">mcourse.cc</h1>
    <div class="am-header-right am-header-nav am-dropdown" data-am-dropdown>
        <a href="${ctx}/userhome/index"> <i class="am-header-icon am-icon-user"></i></a>
    </div>
    <%--<div class="am-header-right am-header-nav am-dropdown" data-am-dropdown>--%>
    ...
    <%--<li><a href="${ctx}/userhome/index">个人中心</a></li>--%>
    <%--<li class="am-divider"></li>--%>
    <%--<li><a href="#">问题反馈</a></li>--%>
    <%--</ul>--%>
    <%--</div>--%>
